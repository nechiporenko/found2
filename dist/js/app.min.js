...
N=!1)}var v,w,x,y,z,A,B,C,D,E,F,G,H,I,J,K=this,L=a(f),M=!1,N=!1,O=/android|ip(hone|od|ad)/i.test(navigator.userAgent),P=L.prop("tabindex");k(j)};a.fn[b]=function(c){return this.each(function(){var d=a.data(this,b);d&&!d.disableOnMobile?""+c===c&&d[c]?d[c]():d.init(c):a.data(this,b,new j(this,c))})},a.fn[b].hooks=f}),function(){var a,b;a=this.jQuery||window.jQuery,b=a(window),a.fn.stick_in_parent=function(c){var d,e,f,g,h,i,j,k,l,m,n;for(null==c&&(c={}),n=c.sticky_class,h=c.inner_scrolling,m=c.recalc_every,l=c.parent,k=c.offset_top,j=c.spacer,e=c.bottoming,null==k&&(k=0),null==l&&(l=void 0),null==h&&(h=!0),null==n&&(n="is_stuck"),d=a(document),null==e&&(e=!0),f=function(c,f,g,i,o,p,q,r){var s,t,u,v,w,x,y,z,A,B,C,D;if(!c.data("sticky_kit")){if(c.data("sticky_kit",!0),w=d.height(),y=c.parent(),null!=l&&(y=y.closest(l)),!y.length)throw"failed to find stick parent";if(s=u=!1,(C=null!=j?j&&c.closest(j):a("<div />"))&&C.css("position",c.css("position")),z=function(){var a,b,e;return!r&&(w=d.height(),a=parseInt(y.css("border-top-width"),10),b=parseInt(y.css("padding-top"),10),f=parseInt(y.css("padding-bottom"),10),g=y.offset().top+a+b,i=y.height(),u&&(s=u=!1,null==j&&(c.insertAfter(C),C.detach()),c.css({position:"",top:"",width:"",bottom:""}).removeClass(n),e=!0),o=c.offset().top-(parseInt(c.css("margin-top"),10)||0)-k,p=c.outerHeight(!0),q=c.css("float"),C&&C.css({width:c.outerWidth(!0),height:p,display:c.css("display"),"vertical-align":c.css("vertical-align"),"float":q}),e)?D():void 0},z(),p!==i)return v=void 0,x=k,B=m,D=function(){var a,l,t,A;return!r&&(t=!1,null!=B&&(--B,0>=B&&(B=m,z(),t=!0)),t||d.height()===w||z(),t=b.scrollTop(),null!=v&&(l=t-v),v=t,u?(e&&(A=t+p+x>i+g,s&&!A&&(s=!1,c.css({position:"fixed",bottom:"",top:x}).trigger("sticky_kit:unbottom"))),o>t&&(u=!1,x=k,null==j&&("left"!==q&&"right"!==q||c.insertAfter(C),C.detach()),a={position:"",width:"",top:""},c.css(a).removeClass(n).trigger("sticky_kit:unstick")),h&&(a=b.height(),p+k>a&&!s&&(x-=l,x=Math.max(a-p,x),x=Math.min(k,x),u&&c.css({top:x+"px"})))):t>o&&(u=!0,a={position:"fixed",top:x},a.width="border-box"===c.css("box-sizing")?c.outerWidth()+"px":c.width()+"px",c.css(a).addClass(n),null==j&&(c.after(C),"left"!==q&&"right"!==q||C.append(c)),c.trigger("sticky_kit:stick")),u&&e&&(null==A&&(A=t+p+x>i+g),!s&&A))?(s=!0,"static"===y.css("position")&&y.css({position:"relative"}),c.css({position:"absolute",bottom:f,top:"auto"}).trigger("sticky_kit:bottom")):void 0},A=function(){return z(),D()},t=function(){return r=!0,b.off("touchmove",D),b.off("scroll",D),b.off("resize",A),a(document.body).off("sticky_kit:recalc",A),c.off("sticky_kit:detach",t),c.removeData("sticky_kit"),c.css({position:"",bottom:"",top:"",width:""}),y.position("position",""),u?(null==j&&("left"!==q&&"right"!==q||c.insertAfter(C),C.remove()),c.removeClass(n)):void 0},b.on("touchmove",D),b.on("scroll",D),b.on("resize",A),a(document.body).on("sticky_kit:recalc",A),c.on("sticky_kit:detach",t),setTimeout(D,0)}},g=0,i=this.length;i>g;g++)c=this[g],f(a(c));return this}}.call(this),jQuery(document).ready(function(a){function b(){var b,c=a(".js-headerslider"),d=a(".b-header"),e=!1,f=200,g=a.viewportH(),h={};h.initSlider=function(){c.bxSlider({mode:"fade",controls:!1,auto:!0,pause:8e3})},h.setMaxHeight=function(){g>1020&&(g=1020),d.css("height",g+"px")},h.checkResize=function(){var b=a.viewportH();Math.abs((b-g)/g)>.15&&(g=b,h.setMaxHeight())},h.endResize=function(){new Date-b<f?setTimeout(h.endResize,f):(e=!1,h.checkResize())},h.startResize=function(){b=new Date,e===!1&&(e=!0,setTimeout(h.endResize,f))},h.setMaxHeight(),h.initSlider(),a(window).bind("resize",h.startResize),a(".b-header__slider").find(".bx-pager-item").hover(function(){c.stopAuto()},function(){c.startAuto()}),a(".h-hero").on("click",".h-hero__btn",function(b){b.preventDefault(),a("html, body").animate({scrollTop:a(a.attr(this,"href")).offset().top},800)})}function c(){var b,c=a(".js-slider"),d=!1,e=200,f={};f.getSliderSettings=function(){var b,c={maxSlides:1,minSlides:1,moveSlides:1,slideWidth:280},d={maxSlides:1,minSlides:1,moveSlides:1,slideWidth:360},e={maxSlides:2,minSlides:2,moveSlides:2,slideWidth:280},f={maxSlides:3,minSlides:3,moveSlides:3,slideWidth:230},g={maxSlides:3,minSlides:3,moveSlides:3,slideWidth:320},h={maxSlides:3,minSlides:3,moveSlides:3,slideWidth:380},i={slideMargin:20,auto:!1,mode:"horizontal",infiniteLoop:!1,hideControlOnEnd:!0,useCSS:!1,nextText:'<i class="icomoon-arrow-right"></i>',prevText:'<i class="icomoon-arrow-left"></i>'},j=a.viewportW();return 450>j&&(b=a.extend(c,i)),j>=450&&600>j&&(b=a.extend(d,i)),j>=600&&768>j&&(b=a.extend(e,i)),j>=768&&1024>j&&(b=a.extend(f,i)),j>=1024&&1200>j&&(b=a.extend(g,i)),j>=1200&&(b=a.extend(h,i)),b},f.reloadSliderSettings=function(){c.reloadSlider(a.extend(f.getSliderSettings(),{startSlide:c.getCurrentSlide()}))},f.endResize=function(){new Date-b<e?setTimeout(f.endResize,e):(d=!1,f.reloadSliderSettings())},f.startResize=function(){b=new Date,d===!1&&(d=!0,setTimeout(f.endResize,e))},c.bxSlider(f.getSliderSettings()),a(window).bind("resize",f.startResize)}function d(){var b,c=a(".js-slider-compact"),d=!1,e=200,f={};f.getSliderSettings=function(){var b,c={maxSlides:1,minSlides:1,moveSlides:1,slideWidth:280},d={maxSlides:1,minSlides:1,moveSlides:1,slideWidth:360},e={maxSlides:2,minSlides:2,moveSlides:2,slideWidth:320},f={maxSlides:3,minSlides:3,moveSlides:3,slideWidth:280},g={slideMargin:20,auto:!1,mode:"horizontal",infiniteLoop:!1,hideControlOnEnd:!0,useCSS:!1,nextText:'<i class="icomoon-arrow-right"></i>',prevText:'<i class="icomoon-arrow-left"></i>'},h=a.viewportW();return 450>h&&(b=a.extend(c,g)),h>=450&&600>h&&(b=a.extend(d,g)),h>=600&&1020>h&&(b=a.extend(e,g)),h>=1020&&(b=a.extend(f,g)),b},f.reloadSliderSettings=function(){c.reloadSlider(a.extend(f.getSliderSettings(),{startSlide:c.getCurrentSlide()}))},f.endResize=function(){new Date-b<e?setTimeout(f.endResize,e):(d=!1,f.reloadSliderSettings())},f.startResize=function(){b=new Date,d===!1&&(d=!0,setTimeout(f.endResize,e))},c.bxSlider(f.getSliderSettings()),a(window).bind("resize",f.startResize)}function e(){var b,c=!1,d=a(".js-sticky"),e=!1,f=200,g={};g.stick=function(){d.stick_in_parent({parent:a(".js-sticky").parents(".page__grid")}),c=!0},g.unstick=function(){d.trigger("sticky_kit:detach"),c=!1},g.recalc=function(){c&&d.trigger("sticky_kit:recalc")},g.checkout=function(){winW=a.viewportW(),winW>=768&&!c&&g.stick(),winW<768&&c&&g.unstick()},g.endResize=function(){new Date-b<f?setTimeout(g.endResize,f):(e=!1,g.checkout())},g.startResize=function(){b=new Date,e===!1&&(e=!0,setTimeout(g.endResize,f))},g.checkout(),a(window).bind("resize",g.startResize)}function f(){var b=a(".js-loadmore"),c=+b.data("total-items"),d=(a("#overlay"),a(window)),e={};e.checkTotal=function(){var a=b.children("li").length;c>a?d.bind("scroll",e.scrollToEnd):b.addClass("loaded")},e.scrollToEnd=function(){var c=b.children("li:last-child"),f=c.outerHeight(),g=verge.inY(c,-f);if(g){d.unbind("scroll",e.scrollToEnd),b.after('<ul class="g-hidden" id="hidden"></ul>');var h=a("#hidden");h.load("ajax/_more-content.html li",function(){var c=0;h.find("li").each(function(){c++;var d=a(this);3>=c&&d.addClass("g-invisible"),b.append(d),3>=c&&d.addClass("showItem-"+c)}),h.remove(),e.checkTotal()})}},e.checkTotal()}function g(){var b=a(".js-select");b.each(function(){a(this).selectric({disableOnMobile:!1,responsive:!0})})}a("body").append('<div id="overlay" class="overlay"></div>'),function(){var b=a(".js-mm"),c=a(".js-mm-toggle"),d=a("html"),e=a("#overlay"),f={};b.find(".m-menu__label").filter(":first").addClass("m-menu__label--close"),c.on("click",function(){a(this).hasClass("active")?f.close():f.show()}),b.on("click",".m-menu__label--close",function(){f.close()}),f.show=function(){d.css("overflow","hidden"),e.show().bind("click",f.close),c.addClass("active"),b.addClass("active")},f.close=function(){e.hide().unbind("click",f.close),c.removeClass("active"),b.removeClass("active"),d.css("overflow","auto")}}(),function(){var b=a(".js-search"),c=a(".js-search-toggle"),d=a("body"),e={};e.showForm=function(){c.addClass("active"),b.fadeIn(400).find("input").filter(":first").focus(),b.find(".h-search").on("mouseleave",function(){d.bind("click",e.hideForm)}).on("mouseenter",function(){d.unbind("click",e.hideForm)})},e.hideForm=function(){c.removeClass("active"),b.fadeOut(400),d.unbind("click",e.hideForm)},c.on("click",function(){a(this).hasClass("active")?e.hideForm():e.showForm()})}(),a(".js-headerslider").length&&b(),a(".js-slider").length&&c(),a(".js-slider-compact").length&&d(),a(".js-sticky").length&&e(),a(".js-loadmore").length&&f(),function(){var b=a('<div class="scroll-up-btn"><i class="icomoon-up"></i></div>');a("body").append(b),a(window).on("scroll",function(){a(this).scrollTop()>300?b.show():b.hide()}),b.on("click",function(){return a("html, body").animate({scrollTop:0},800),!1})}(),a(".js-select").length&&g();var h=function(b){var c,d,e={},f=a(window),g=a("#overlay");return d=a('<a class="modal__close" href="#"><i class="icon-cancel"></i></a>'),d.on("click",function(a){a.preventDefault(),e.close()}),e.center=function(){var a,b;a=Math.max(f.height()-c.outerHeight(),0)/2,b=Math.max(f.width()-c.outerWidth(),0)/2,c.css({top:a+f.scrollTop(),left:b+f.scrollLeft()})},e.open=function(b){c=a(b),c.append(d),e.center(),f.bind("resize.modal",e.center),c.show(),g.show().bind("click",e.close)},e.close=function(){c.hide(),g.hide().unbind("click",e.close),f.unbind("resize.modal")},a("[data-modal]").on("click",function(b){b.preventDefault();var c=a(this).data("modal");c&&h.open(c)}),e}()});